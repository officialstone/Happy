...
unsigned int nStakeMinAge = 60 * 60 * 12;	// minimum age for coin age: 12hours
unsigned int nStakeMaxAge = 60* 60 * 24 * 30;	// stake age of coin age: 30days
unsigned int nStakeTargetSpacing = 30;			// 30 sec block spacing

int64 nChainStartTime = 1401070442;
...
const string strMessageMagic = "Happycoin Signed Message:\n";
...
static const int CUTOFF_HEIGHT = POW_CUTOFF_HEIGHT;	// Height at the end of 7 Days
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Happycoin
    bool fStrictPayToScriptHash = true; // Always active in Happycoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Happycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
      if (!fAllowNew)
        ...
        // Genesis block
        const char* pszTimestamp = "Relaunch time 26 May 2014";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x7cdaa8c4239c489507680fe06d68418d85ce20feb3dd25330e19fe296733e772"));
...
unsigned char pchMessageStart[4] = { 0xcd, 0xbf, 0xdc, 0xfd };
