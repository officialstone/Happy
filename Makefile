#############################################################################
# Makefile for building: Happycoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sun Jun 1 19:32:46 2014
# Project:  Happycoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Happycoin-qt.pro
#############################################################################
...
Makefile: Happycoin-qt.pro  ../../Qt/4.8.5/mkspecs/default/qmake.conf ../../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Happycoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/Happycoin/Happycoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/Happycoin/Happycoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/Happycoin/Happycoin/src/leveldb/libleveldb.a: FORCE
	cd C:/Happycoin/Happycoin/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -O2" libleveldb.a libmemenv.a && ranlib C:/Happycoin/Happycoin/src/leveldb/libleveldb.a && ranlib C:/Happycoin/Happycoin/src/leveldb/libmemenv.a
